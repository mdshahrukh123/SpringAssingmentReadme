<center>
<h1> ToDo App MANAGEMENT SYSTEM </h1>
</center>
<center>
<a href="Java url">
...
This project is a ToDo management system built using Spring Boot with Java.
...
The ToDo data model is defined in the User class, which has the following attributes:
```
ToDoId : unique identifier for each user
