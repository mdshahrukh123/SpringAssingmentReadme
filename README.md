<center>
<h1> DOCTOR APP MANAGEMENT SYSTEM </h1>
</center>
<center>
<a href="Java url">
...
This project is a Doctor management system built using Spring Boot with Java.
...
The Patient data model is defined in the User class, which has the following attributes:
```
PatientrId : unique identifier for each user
PatientName : name of the user
PatientAge : Organisation user name
...
The Doctor data model is defined in the User class, which has the following attributes:
```
DoctorId : unique identifier for each user
DoctorName : name of the user
DoctorAge : Organisation user name
Address : address of the user
Phone Number : Phone number of the user
```
...
The Appointment  data model is defined in the User class, which has the following attributes:
```
AppointmentId : unique identifier for each user
Name : name of the user
Date : address of the user
AppointmentNumber : Phone number of the user
```
