...
The Post data model is defined in the User class, which has the following attributes:
```
PostId : unique identifier for each user
PostName : name of the user
PostType : Organisation user name
Address : address of the user
